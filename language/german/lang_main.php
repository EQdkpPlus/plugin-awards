...
$lang = array(
  ...
  'aw_manage_cronmodules'		=> 'Module verwalten',
  'aw_tab_assign'				=> '<i class="adminicon"></i>Alle Zuweisungen',
  'aw_tab_achieve'				=> '<i class="adminicon"></i>Alle Erfolge',
  ...
  'aw_auto_assign_help'			=> '"Plugins: Awards" Cronjob muss aktiviert sein!',
  'aw_icon_help'				=> 'Wähle ein passendes Icon aus oder lade ein eigenes hoch.<br />SVG Bilder bieten zusätzliche Farbmöglichkeiten, dazu sollten sie aber entsprechend angepasst sein siehe dazu das <a href="https://eqdkp-plus.eu/wiki/Plugin:_Awards">Wiki</a>.',
  ...
  'aw_module_all'				=> 'Alle',
  'aw_module_any'				=> 'Eines',
  'aw_module_choose_option'		=> '-- Wähle eine Bedingung --',
  ...
  'aw_upd_success'				=> '%s wurde geändert',
  'aw_upd_nosuccess'			=> '%s konnte nicht geändert werden',
